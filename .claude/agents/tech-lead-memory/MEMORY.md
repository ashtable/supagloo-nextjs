...
- [TranslationSchema is a free string](translation-schema-free-string.md) — task 58 widened nextjs `TranslationSchema` KJV/BSB enum → `z.string().min(1)` (§2.11/§9-Q10); fixed studio re-hydration blocked at the `fetchManifest` read; reversed task-57's deferral
